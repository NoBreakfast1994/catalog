...
class BusinessesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create business' do
    assert_difference('Business.count') do
      post businesses_url, params: { business: { name: @business.name, user_id: @business.user_id } }
    end
  ...
  test 'should update business' do
    patch business_url(@business), params: { business: { name: @business.name, user_id: @business.user_id } }
